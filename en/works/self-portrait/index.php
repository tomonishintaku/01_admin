		   ...
		   ?>
			  ...
			  <figure class="inner__col self-portrait-image-wrap">
				  <a href="/images/works/self-portrait/<?php echo $imageFile ?>@2x.jpg" class="zoom self-portrait-image-wrap__inner">
                      <img alt="Contemporary artist SHINTAKU Tomoni's <?php echo $year.'/'.$month.'/'.$day ?> Self-portrait or pencil drawing" data-src="/images/works/self-portrait/<?php echo $imageFile ?>.jpg" src="/images/common/white.gif" class="lazyload" loading="lazy">
                  </a>

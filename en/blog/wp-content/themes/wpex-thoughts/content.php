		...
		<div class="post-entry-text clearfix">
			<header>
				...
				<ul class="post-entry-meta">
					<li><time datetime="<?php echo get_the_date(); ?>" itemprop="datepublished"><?php echo get_the_date(); ?></time></li>
...
<div class="post-pagination_use" class="clearfix">
	<div class="post-prev"><?php next_post_link('%link', '<i class="fa fa-caret-left" aria-hidden="true"></i> PREV<span class="title">%title</span>', false); ?></div> 
	<div class="post-next"><?php previous_post_link('%link', 'NEXT  <i class="fa fa-caret-right" aria-hidden="true"></i><span class="title">%title</span>', false); ?></div>
</div><!-- /post-pagination -->

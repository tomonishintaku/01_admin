...
<ul class="clearfix">
	...
	<li>
		...
		<h3>遺伝子組み換えでない</h3>
		<p>現代、誰もが避けがたく口にせざるを得ない遺伝子組み換え食品にまつわる不安や不透明さを具現化したシリーズ。</p></a>
	</li>
	<li>
	...
	<!--li>
		<a href="/works/leathervores.html"><img alt="皮革食" src="/images/works/nav/leathervores.jpg">
		<h3>皮革食</h3>
		<p>革ベルトや革靴を食料として調理することで、平和に浸った現代人の意識構造に切り込むシリーズ。</p></a>
	</li-->
	<li>
	...
	<li>
		...
		<h3>作家ポートフォリオ(PDF)</h3>
		<p>作家の全体像を概観でkきるPDF版の作品ポートフォリオをダウンロードいただけます。</p></a>
	</li>
	<li>

				<section id="top_bnr_space" class="foot_bnr">
					...
					<ul class="clearfix">
						...
						<!--li><a href="https://affordableartfair.com/fairs/singapore" target="_blank"><img class="lazyload" src="/images/banner/2018/bnr_aaf-sg-2018_jp.png" alt="アフォーダブルアートフェア、Affordable Art Fair(シンガポール) 11/16〜18"></a></li>

						<li><a href="/exhibition/2018_colour-me-well.html" onclick="ga('send','event','banner','click','colour2018', 1);"><img class="lazyload" src="/images/banner/bnr_colour-me-well2018_jp.png" alt="新宅睦仁個展COLOUR ME WELL/One East Asia Gallery/シンガポール"></a></li-->

						<li><a href="http://ec.tagboat.com/jp/products/list.php?author_id=100265&tngs_flg=0" target="_blank" onclick="ga('send','event','banner','click','tagboat', 1);"><img class="lazyload" src="/images/top/bnr_tagboat.jpg" alt="タグボートで新宅睦仁作品を販売中"></a></li>
						...
						<li><a href="http://tomonishintaku.com/blog/voice/" onclick="ga('send','event','banner','click','voice-blog', 1);"><img class="lazyload" src="/images/banner/bnr_voice-blog.png" title="現代美術家新宅睦仁の音声ブログ" alt="現代美術家新宅睦仁の音声ブログ。その日に考えていることをとりとめもなく話す。毎日更新"></a></li>

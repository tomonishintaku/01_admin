...
<meta charset="UTF-8"><meta name="viewport" content="width=device-width"><meta name="author" content="新宅睦仁" /><meta name="copyright" content="Shintaku Tomoni" />

<!--meta property="og:title" content="javascript:pageTitle()" /-->
...
<meta property="og:type" content="website" /><meta property="og:image" content="https://tomonishintaku.com/images/common/og-image.png" /><meta property="og:url" content="https://tomonishintaku.com<?php echo $_SERVER['PHP_SELF'] ?>" /><meta property="og:description" content="食をテーマとする現代美術家の新宅睦仁の絵画、立体、インスタレ－ション作品、コンセプト、個展・グループ展情報の紹介" /><meta property="og:site_name" content="現代美術家の新宅睦仁のWebサイト" /><meta name="twitter:card" content="summary"><meta name="twitter:site" content="@tomonishintaku">

<!--meta name="twitter:title" content="<script>document.write(PageTitle);</script>"-->
<script type="text/javascript">
  var meta = document.createElement('meta');

<?php //require_once dirname(__FILE__).'/common/functions.php';?>
    ...
    <?php
        //Branch banner for Japanese and English
           ...
           if(strstr($url,'/en/')==true):
				?>
    <?php $bnr = file_cget_contents('https://tomonishintaku.com/en/inc/bnr.php'); echo $bnr; ?>
    <?php else: ?>
    <?php $bnr = file_cget_contents('https://tomonishintaku.com/inc/bnr.php'); echo $bnr; ?>
    <?php endif; 
        //Branch banner for Japanese and English END
        ?>
    ...
    <div class="foot__sns">
        ...
        //Branch SNS for Japanese and English
           ...
           if(strstr($url,'/en/')==true):
                ?>
    <?php $bnr = file_cget_contents('https://tomonishintaku.com/en/inc/sns.php'); echo $bnr; ?>
    <?php else: ?>
    <?php $bnr = file_cget_contents('https://tomonishintaku.com/inc/sns.php'); echo $bnr; ?>
    <?php endif; 

<?php $bnr = file_get_contents('https://tomonishintaku.com/inc/bnr.php'); echo $bnr; ?>
 <section id="foot_only"> <p id="pagetop"><a href="#head"><i class="fa fa-chevron-circle-up"></i></a></p><div class="clearfix" id="foot"><ul><?php $sns = file_get_contents('https://tomonishintaku.com/inc/sns.php'); echo $sns; ?></ul> <p class="public_caution">当サイト内の文章・画像等の内容の無断転載及び複製等の行為はご遠慮ください。____</p><address> Copyright <span class="cpy">&copy;</span> 2012-<?php echo date("Y"); ?> Shintaku Tomoni. All Rights Reserved. </address> </div>

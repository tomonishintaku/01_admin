	...
	function st_add_orignal_quicktags() {
		if ( wp_script_is( 'quicktags' ) ) { ?>
			<script type="text/javascript">
				...
				QTags.addButton('ed_reference_link', '参照リンク', '<span class="sub_txt"><a href="" target="_blank" rel="noopener noreferrer">', '</a></span>');
				QTags.addButton('ed_tweet_quote', 'ツイート引用', '<blockquote class="tw">氏名(<a href="twitter-account-URL" target="_blank" rel="noopener noreferrer">@account-name</a>)', '</a></span></blockquote>');
...
// USE add functions by including
